...
from volaris.backtest.position import BasePosition
...
class Exchange:
        ...
        **kwargs: Any,
        ...
        :param volume_threshold: Union[
                                ...
                                1) ("cum" or "current", limit_str) denotes a single volume limit.
                                    - limit_str is volaris data expression which is allowed to define your own Operator.
                                    Please refer to volaris/contrib/ops/high_freq.py, here are any custom operator for
                                    high frequency, such as DayCumsum. !!!NOTE: if you want you use the custom
                                    operator, you need to register it in volaris_init.
    ...
    LT_TP_EXP = "(exp)"  # Tuple[str, str]:  the limitation is calculated by a Volaris expression.
    ...
    def _get_vol_limit(volume_threshold: Union[tuple, dict, None]) -> Tuple[Optional[list], Optional[list], set]:
        ...
        get the fields need to get from volaris.
        ...
        -------
        fields: set
            the fields need to get from volaris.
