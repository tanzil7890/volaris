...
from volaris.utils.resam import resam_calendar
from volaris.config import C
from volaris.data.cache import H
from volaris.log import get_module_logger
from volaris.data.storage import CalendarStorage, InstrumentStorage, FeatureStorage, CalVT, InstKT, InstVT
...
class FileStorageMixin:
    ...
    #   2. provider_uri in volaris.config.C
