...
from volaris.utils import load_dataset, init_instance_by_config, time_to_slc_point
...
class DLWParser(DataLoader):
    ...
    Extracting this class so that VolarisDataLoader and other dataloaders(such as QdbDataLoader) can share the fields.
    """
...
class VolarisDataLoader(DLWParser):
    """Same as VolarisDataLoader. The fields can be define by config"""
...
class DataLoaderDH(DataLoader):
    ...
    def __init__(self, handler_config: dict, fetch_kwargs: dict = {}, is_group=False):
        ...
        """
        from volaris.data.dataset.handler import DataHandler  # pylint: disable=C0415
