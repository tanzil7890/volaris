...
"""
Volaris follow the logic below to supporting point-in-time database
...
Volaris will use the operator `P` to perform the collapse.
"""
import numpy as np
import pandas as pd
from volaris.data.ops import ElemOperator
