...
from volaris.model.ens.group import RollingGroup
from volaris.utils import transform_end_date
from volaris.workflow.online.utils import OnlineTool, OnlineToolR
from volaris.workflow.recorder import Recorder
from volaris.workflow.task.collect import Collector, RecorderCollector
from volaris.workflow.task.gen import RollingGen, task_generator
from volaris.workflow.task.utils import TimeAdjuster
...
class OnlineStrategy:
    ...
    def __init__(self, name_id: str):
        """
        Init OnlineStrategy.
        This module **MUST** use `Trainer <../reference/api.html#volaris.model.trainer.Trainer>`_ to finishing model training.

        Args:
            name_id (str): a unique name or id.
            trainer (volaris.model.trainer.Trainer, optional): a instance of Trainer. Defaults to None.
        """
