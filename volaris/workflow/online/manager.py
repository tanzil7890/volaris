...
import pandas as pd
from volaris import get_module_logger
from volaris.data.data import D
from volaris.log import set_global_logger_level
from volaris.model.ens.ensemble import AverageEnsemble
from volaris.model.trainer import Trainer, TrainerR
from volaris.utils.serial import Serializable
from volaris.workflow.online.strategy import OnlineStrategy
from volaris.workflow.task.collect import MergeCollector
...
class OnlineManager(Serializable):
    ...
    def __init__(
        ...
        Args:
            ...
            trainer (volaris.model.trainer.Trainer): the trainer to train task. None for using TrainerR.
