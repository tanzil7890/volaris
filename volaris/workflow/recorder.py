...
from volaris.utils.paral import AsyncCaller
...
class Recorder:
    ...
    def save_objects(self, local_path=None, artifact_path=None, **kwargs):
        ...
        Please refer to the docs of volaris.workflow:R.save_objects
...
class MLflowRecorder(Recorder):
    ...
    def start_run(self):
        ...
        self.log_params(
            **{k: v for k, v in os.environ.items() if k.startswith("_VOlaris_")}
