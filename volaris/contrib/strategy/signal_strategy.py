...
from volaris.data.dataset import Dataset
from volaris.model.base import BaseModel
from volaris.strategy.base import BaseStrategy
from volaris.backtest.position import Position
from volaris.backtest.signal import Signal, create_signal_from
...
class BaseSignalStrategy(BaseStrategy, ABC):
    def __init__(
        ...
        **kwargs,
        ...
        -----------
        signal :
            the information to describe a signal. Please refer to the docs of `volaris.backtest.signal.create_signal_from`
        ...
        # This is trying to be compatible with previous version of volaris task config
...
class EnhancedIndexingStrategy(WeightStrategyBase):
    ...
    `volaris.model.riskmodel.structured.StructuredCovEstimator` to prepare these data.
