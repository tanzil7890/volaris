    ...
    **NOTE**
    ...
    def _dump_data_for_proxy_model(self):
        ...
        handler = DataHandlerLP(
            data_loader={
                "class": "volaris.data.dataset.loader.StaticDataLoader",
    ...
    def _train_meta_model(self, fill_method="max"):
        ...
        proxy_forecast_model_task = {
            ...
            # "record": ["volaris.workflow.record_temp.SignalRecord"]
        }
    ...
    def get_task_list(self):
        ...
        # 3) meta model make inference and get new volaris task
