...
from volaris.data.dataset.utils import convert_index_format

from volaris.utils import lazy_sort_index
...
from volaris.utils.file import get_io_object
from volaris.backtest.utils import get_start_end_idx
    ...
    def __init__(
        ...
        **kwargs,
        ...
        trade_range : Tuple[int, int]
            ...
            - `volaris/utils/time.py:def get_day_min_idx_range` can help you create the index range easier
