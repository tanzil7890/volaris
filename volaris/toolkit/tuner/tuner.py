...
class VOlarisTuner(Tuner):
    ...
    def fetch_result(self):
        ...
        exp_info_path = os.path.join(self.ex_dir, VOlarisTuner.EXP_INFO_NAME)
        ...
        exp_result_dir = os.path.join(self.ex_dir, VOlarisTuner.EXP_RESULT_DIR.format(estimator_ex_id))
        exp_result_path = os.path.join(exp_result_dir, VOlarisTuner.EXP_RESULT_NAME)
    ...
    def setup_estimator_config(self, params):
        ...
        estimator_path = os.path.join(
            ...
            VOlarisTuner.ESTIMATOR_CONFIG_NAME,
        )
    ...
    def save_local_best_params(self):
        TimeInspector.set_time_mark()
        local_best_params_path = os.path.join(self.ex_dir, VOlarisTuner.LOCAL_BEST_PARAMS_NAME)
