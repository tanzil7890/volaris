...
from volaris.backtest import INDICATOR_METRIC, collect_data_loop, get_strategy_executor
from volaris.backtest.decision import BaseTradeDecision, Order, OrderDir, TradeRangeByTime
from volaris.backtest.executor import SimulatorExecutor
from volaris.backtest.high_performance_ds import BaseOrderIndicator
from volaris.rl.contrib.naive_config_parser import get_backtest_config_fromfile
from volaris.rl.contrib.utils import read_order_file
from volaris.rl.data.integration import init_volaris
from volaris.rl.order_execution.simulator_volaris import SingleAssetOrderExecution
from volaris.typehint import Literal
...
def _get_multi_level_executor_config(
    ...
    executor_config = {
        ...
        "module_path": "volaris.backtest.executor",
        "kwargs": {
...
def single_with_simulator(
    ...
    """
    init_volaris(backtest_config["volaris"])
