...
from volaris.rl.simulator import InitialStateType
from volaris.rl.utils import EnvWrapper, FiniteEnvType, LogBuffer, LogCollector, LogLevel, LogWriter, vectorize_env
...
class Trainer:
    ...
    fast_dev_run
        ...
        For :class:`~volaris.rl.vessel.TrainingVessel`, if greater than zero,
