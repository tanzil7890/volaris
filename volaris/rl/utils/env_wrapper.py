...
from volaris.rl.aux_info import AuxiliaryInfoCollector
from volaris.rl.interpreter import ActionInterpreter, ObsType, PolicyActType, StateInterpreter
from volaris.rl.reward import Reward
from volaris.rl.simulator import ActType, InitialStateType, Simulator, StateType
from volaris.typehint import TypedDict
...
class EnvWrapper(
    ...
    """Volaris-based RL environment, subclassing ``gym.Env``.
    ...
    seed_iterator
        An iterable of seed. With the help of :class:`volaris.rl.utils.DataQueue`,
