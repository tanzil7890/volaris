...
class FiniteVectorEnv(BaseVectorEnv):
    ...
    The requirement is to make every possible seed (stored in :class:`volaris.rl.utils.DataQueue` in our case)
    ...
    The single environment (should be :class:`volaris.rl.utils.EnvWrapper` in our case) is responsible for
    ...
    from child workers. See :class:`volaris.rl.utils.LogWriter`.
    """
