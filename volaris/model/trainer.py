...
``Volaris`` offer two kinds of Trainer, ``TrainerR`` is the simplest way and ``TrainerRM`` is based on TaskManager to help manager tasks lifecycle automatically.
"""
...
from volaris.utils import (
    auto_filter_kwargs,
    fill_placeholder,
    flatten_dict,
    init_instance_by_config,
)
from volaris.utils.paral import call_in_subproc
from volaris.workflow import R
from volaris.workflow.recorder import Recorder
from volaris.workflow.task.manage import TaskManager, run_task
