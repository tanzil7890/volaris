...
class CollectorFutureCalendar:
    ...
    def __init__(self, volaris_dir: Union[str, Path], start_date: str = None, end_date: str = None):
        """
        ...
        """
        self.volaris_dir = Path(volaris_dir).expanduser().absolute()
        self.calendar_path = self.volaris_dir.joinpath("calendars/day.txt")
        self.future_path = self.volaris_dir.joinpath("calendars/day_future.txt")
...
def run(volaris_dir: Union[str, Path], region: str = "cn", start_date: str = None, end_date: str = None):
    ...
    -------
        ...
        $ python future_calendar_collector.py --volaris_data_1d_dir <user data dir> --region cn
    """
    ...
    collector = _class(volaris_dir=volaris_dir, start_date=start_date, end_date=end_date)
