...
python collector.py --index_name IBOV --volaris_dir ~/.volaris/volaris_data/br_data --method parse_instruments

# parse new companies
python collector.py --index_name IBOV --volaris_dir ~/.volaris/volaris_data/br_data --method save_new_companies
```
