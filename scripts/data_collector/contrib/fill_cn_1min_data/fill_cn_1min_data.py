...
def fill_1min_using_1d(
    ...
    volaris_data_1d_dir: str
        1d volaris data(bin data) dir, from: https://volaris.readthedocs.io/en/latest/component/data.html#converting-csv-format-into-volaris-format
    max_workers: int
    ...
    volaris_data_1d_dir = Path(volaris_data_1d_dir).expanduser().resolve()

    min_date, max_date = get_date_range(data_1min_dir, max_workers, date_field_name)
    symbols_1min = get_symbols(data_1min_dir)

    volaris.init(provider_uri=str(volaris_data_1d_dir))
