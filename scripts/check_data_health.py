...
class DataHealthChecker:
    ...
    def __init__(
        ...
        assert csv_path or volaris_dir, "One of csv_path or volaris_dir should be provided."
        assert not (csv_path and volaris_dir), "Only one of csv_path or volaris_dir should be provided."
        ...
        if csv_path:
            ...
            volaris.init(provider_uri=volaris_dir)
            self.load_volaris_data()

    def load_volaris_data(self):
